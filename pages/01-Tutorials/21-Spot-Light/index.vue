...
<script>
  ...
  export default {
    ...
    data: () => ({
      ...
      project: null,
      sliders: {
        ligRotX: { model: 0, min: -100, max: 100, step: 0.01, label: 'ligRotX', side: "L"},
        ligRotY: { model: 0, min: -100, max: 100, step: 0.01, label: 'ligRotY', side: "L"},
        rotation: { model: 60, min: -360, max: 360, step: 0.01, label: 'rotation', side: "L"},
        shine: { model: 60, min: 1, max: 300, step: 0.01, label: 'shine', side: "L"},
        innerLimit: { model: 10, min: 1, max: 100, step: 0.01, label: 'innerLimit', side: "L"},
        outerLimit: { model: 20, min: 1, max: 100, step: 0.01, label: 'outerLimit', side: "L"},
